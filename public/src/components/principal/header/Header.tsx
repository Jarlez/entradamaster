...
const cidades = [
  ...
  "Santiago del Estero", "Corrientes", "Bahía Blanca", "San Salvador de Jujuy", "Posadas",
  "Paraná", "Formosa", "San Luis", "La Rioja", "Rio Gallegos", "Comodoro Rivadavia",
  "San Fernando del Valle de Catamarca", "Trelew", "Ushuaia", "Bariloche", "Villa María",
  "Concordia", "Rafaela", "Pergamino"
];

const HeaderComponent: React.FC<Props> = ({ home, buyPage }) => {
  ...
  // condicional render for admin role
      ...
      <header id="inicio" className={style.header}>
        <div className={style.container_1}>
          ...
          <div className={style.socials}>
            <a href="#" aria-label="Facebook"><FiFacebook className={style.icon} /></a>
            <a href="#" aria-label="Instagram"><AiOutlineInstagram className={style.icon} /></a>
          </div>
        </div>

        <div className={style.container_2}>
          <div className={style.left_container}>
            {/* Menu lateral (apenas buyPage) */}
            {buyPage && (
              <>
          ...
          {/* CAMPO DE DATA REMOVIDO TEMPORARIAMENTE DO HEADER */}
          {/*
          <input
            ref={datePickerRef}
            type="text"
            ...
            disabled={!cidade}
            value={dataSelecionada ? new Date(dataSelecionada).toLocaleDateString() : ""}
            readOnly
          />
          */}
          ...
          >
            <div className="absolute right-0 h-screen overflow-y-auto bg-gray-50 p-8 2xl:w-4/12">
              ...
              {notifications.map((notificacao) => (
                <div key={notificacao.id} className="mt-5">
